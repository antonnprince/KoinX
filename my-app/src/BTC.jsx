...
const BTC = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row rounded-xl justify-between mt-8 py-8 ml-4 bg-slate-200 mr-auto my-8'>
      
      <div className=' w-full'>
        <TradingViewWidget />
      </div>

      <div className='block flex-col mx-auto mx-2 lg:mx-8 w-auto lg:w-1/2 space-y-8 '>
